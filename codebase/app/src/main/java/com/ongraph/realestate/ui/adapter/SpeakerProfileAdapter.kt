...
class SpeakerProfileAdapter(var context:Context, var eventList: ArrayList<Speaker>) : RecyclerView.Adapter<SpeakerProfileAdapter.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): MyViewHolder {
        return MyViewHolder(
            LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_speaker_profile_layout, parent, false)
        )
    }
