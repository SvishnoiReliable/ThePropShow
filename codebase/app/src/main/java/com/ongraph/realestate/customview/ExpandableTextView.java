package com.ongraph.realestate.customview;
        ...
        post(new Runnable() {
            public void run() {
                /*if (getLineCount() > MAX_LINES)
                    setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, R.mipmap.show_less_text);
                else
                    setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, R.mipmap.show_more_text);
*/
